...
This directory contains the maintainer-facing documentation for GEO Pulse China Agent v0.7.
...
- [Production Deployment Guide](PRODUCTION_DEPLOYMENT.md): single-user/single-tenant v0.7 deployment, environment, Docker, health checks, backup, import, and rollback.
...
- [Roadmap](ROADMAP.md): what is done, what remains local-first, and what belongs to post-v0.7 production hardening.
...
The `reports/` directory contains audit, benchmark, and security hardening notes used during MVP, v0.2, v0.3, v0.4, v0.5, v0.6, and v0.7 preparation.
