...
This directory contains the maintainer-facing documentation for GEO Pulse China Agent v0.10.0.
...
- [Production Deployment Guide](PRODUCTION_DEPLOYMENT.md): one-organization v0.10.0 deployment, built-in login, roles, International GEO site audit, asset generation, environment, Docker, health checks, launch preflight, backup, import, CI gate, and rollback.
...
The `reports/` directory contains audit, benchmark, and security hardening notes used during MVP, v0.2, v0.3, v0.4, v0.5, v0.6, v0.7, v0.8, v0.9, v0.9.1, and v0.10 preparation.
