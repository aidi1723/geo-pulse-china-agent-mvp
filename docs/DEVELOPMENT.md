...
GEO Pulse China Agent v0.14.0 is intentionally small:
...
- UI rendering for the prototype pages, including International GEO site audit, crawl evidence, score breakdown, visibility panels, prompt snapshots, evidence asset opportunities, queue state, review state, and asset previews.
- Persistence, scheduler, audit, connector, source adapter, campaign, publishing, visibility, and International GEO site audit/crawl evidence/visibility/evidence-asset flows.
