...
- v0.21 阶段收口：[docs/STAGE_V0_21_CLOSEOUT.md](docs/STAGE_V0_21_CLOSEOUT.md)
- 项目审查与优化收尾：[docs/PROJECT_AUDIT_OPTIMIZATION_CLOSEOUT_2026-07-16.md](docs/PROJECT_AUDIT_OPTIMIZATION_CLOSEOUT_2026-07-16.md)
- GitHub 与文档对齐收尾：[docs/GITHUB_DOCUMENTATION_CLOSEOUT_2026-07-16.md](docs/GITHUB_DOCUMENTATION_CLOSEOUT_2026-07-16.md)
...
- 数据层、持久化、调度器、权限、审计、连接器和 International GEO 工作流验收
- 本地 HTTP API、安全头、请求体限制、限流、认证和远程访问边界验收
- 前端路由、页面级数据计划、响应式布局、可访问语义和设计系统源码验收
...
- v0.21 OpenAI-compatible LLM generation，包括可配置且脱敏的 `openai_compatible` provider、连接测试、LLM-first 文章与平台改写生成、`local_rules` 失败回退和 provider provenance；只允许调用操作员配置的内容生成 endpoint，生成结果仍需人工审核且不会自动发布
